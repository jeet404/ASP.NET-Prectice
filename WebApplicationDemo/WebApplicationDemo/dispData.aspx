<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="dispData.aspx.cs" Inherits="WebApplicationDemo.WebForm1" %>
            ...
            <AlternatingRowStyle BackColor="White" />  
             <columns>  
                 ...
                 <asp:TemplateField HeaderText="Mobile No">  
                     <ItemTemplate>  
                         <asp:Label ID="Lblmno" runat="server" Text='<%#Bind("mobile") %>'></asp:Label>  
                     </ItemTemplate>  
                 </asp:TemplateField>  
